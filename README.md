...
This README offers a simplified summary of our work, distinct from the full technical report. Here we highlight the strengths, limitations, and applicability of five major fake-news datasets evaluated through classical machine learning and deep learning approaches. Based on this comparison, **WELFake** was chosen as the primary dataset for its balance and ethical construction and further analyzed with **SHAP (SHapley Additive exPlanations)** technique.
